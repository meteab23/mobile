...
// .wrangler/tmp/pages-EqhCbk/bundledWorker-0.47555348763072836.mjs
...
async function E(e, { request: t, assetsFetcher: r, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        a = S(await r.fetch(L(c, e.path ?? n))), e.headers && _(a.headers, e.headers);
        break;
      }
      case "static": {
...
// .wrangler/tmp/pages-EqhCbk/qvoc8xdt83.js
...
// .wrangler/tmp/bundle-Y19CVQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Y19CVQ/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=qvoc8xdt83.js.map
